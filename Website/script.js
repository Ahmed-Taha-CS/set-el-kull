(function() {
    ...
    window.handleLogin = function() {
        ...
        if (email === ADMIN_EMAIL && password === ADMIN_PASSWORD) {
            isAdmin = true;
            loggedIn = true;
            user = { name: 'Admin User', email: ADMIN_EMAIL, isAdmin: true };
            ...
            if (userData) {
                loggedIn = true;
                user = { name: userData.name, email: userData.email, isAdmin: false };
                closeModal('loginModal');
                updateCommentForm();
                updateAuthButtons();
                showMainApp(false);
    ...
    function clearAllFieldFeedback() {
        const fields = ['recipeName', 'recipeArabic', 'recipeTime', 'recipeServings', 
                        'recipeCalories', 'recipeProtein', 'recipeCarbs', 'recipeFats',
    ...
    function setupRecipeFormValidation() {
        ...
        // Special handling for ingredients and instructions
    ...
    window.editRecipe = function(catKey, index) {
        ...
        // Extract numbers from time and servings strings
    ...
    function updateFavoriteIconsOnly() {
        // Update all favorite icon buttons on recipe cards WITHOUT re-rendering
    ...
    function updateFavDisplay() {
        ...
        // Update detail page favorite button if a recipe is open
        if (currentRecipe) {
        ...
        // Update favorite icons on recipe cards without re-rendering categories
   ...
   if (catContainer) {
    catContainer.addEventListener('click', (e) => {
        // Check if click is on favorite icon or its children
